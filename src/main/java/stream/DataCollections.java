...
public class DataCollections {
    ...
    private static final String[] surnames = { "Wójcicki", "Czernek", "Bogusz", "Dyga", "Uliński", "Kuś", "Basiak", "Michałkiewicz",
            "Piecha", "Ziemiański", "Szwarc", "Kudliński", "Wojtala", "Nikiel",  "Kozera", "Szala", "Kalina", "Wojnarowski", "Krzempek",
            "Chowaniec", "Lesiński", "Szumski", "Kępczyński", "Sałaciński", "Kuc", "Chełmiński", "Migdał", "Szreder", "Paszkowski",
            "Chuda", "Krysiak", "Makuła", "Jarząb", "Nawrot", "Kościuk", "Hołub", "Bućko", "Kawa", "Bukała", "Gurgul", "Nowek", "Ołdakowski", "Trzeciak",
            "Gałkowski", "Łazowski", "Kabat", "Pawelski", "Gruszecki", "Cymerman", "Wojtczak", "Mucha", "Taras", "Tryba", "Woźnica", "Dyrcz", "Naruszewicz", "Wrzesiński", "Prusaczyk",
            "Kasperek", "Koziarski", "Gnat", "Bielawski", "Błaszczak", "Smółka", "Szkudlarek", "Rostkowski", "Cwynar", "Górowski", "Kulka", "Burdzy", "Ciach", "Binkowski", "Rękawek", "Majek", "Sułkowski", "Rolnik",
            "Piekarz", "Andrzejewski", "Durak", "Rejman", "Pacak", "Wojcieszek", "Koliński", "Dulski", "Janiczek", "Andrzejczyk",
            "Andrzejczuk", "Kacprzyk", "Majkut", "Adamus", "Wąs", "Radecki", "Czerski", "Byrski", "Maciążek", "Nalepka", "Bojar",
            "Dziadek", "Mikucki", "Wodnicki", "Franek", "Żabicki", "Kokociński", "Deska", "Głąb", "Michałowicz", "Wojtecki", "Ludwig",
            "Ołdak", "Gołębiewski", "Pawlas", "Kurzeja", "Suchomski", "Podbielski", "Stręk", "Lisiecki", "Świtoń", "Siekierski", "Dolny",
            "Wycisk", "Korytkowski", "Solarski", "Wrześniewski", "Pajewski", "Szyszka", "Kociołek", "Iskra", "Zientek", "Jadach", "Marcol",
            "Kurzyński", "Podolak", "Kuczkowski", "Jamka", "Kot", "Konkel", "Dobrosielski", "Stachyra", "Kotwicki", "Magdziarz", "Czok", "Mroczka",
            "Formela", "Karpiuk", "Kamiński", "Pisarczyk", "Kulpa", "Koczur", "Raczek", "Borkowski", "Kardas", "Sokalski", "Szpakowski", "Chodkiewicz",
            "Frankowski", "Głażewski", "Szura", "Konarzewski", "Sierpiński", "Bijak", "Pisarski", "Gawor", "Zdun", "Sielicki", "Pudełko",
            "Ilczuk", "Kozerski", "Klimiuk", "Sobol", "Kocemba", "Barszcz", "Koszyk", "Musioł", "Tarasiuk", "Pietrzykowski", "Gazda",
            "Tymiński", "Łopatka", "Konior", "Batko", "Walkowicz", "Szaniawski", "Wandzel", "Krzewiński", "Aftyka", "Skrok", "Działak",
            "Pluciński", "Gruda", "Nicpoń", "Kiełpiński", "Federowicz", "Pędzich", "Makówka", "Klawikowski", "Respondek", "Piechowski",
            "Dłużniewski", "Brudnicki", "Majka", "Całka", "Luty", "Grzesiuk", "Misiura", "Miłosz", "Juszczyk", "Mrugała", "Tylkowski",
            "Zielonka", "Oleś", "Rakowski", "Nawrocki", "Sieroń", "Pietrucha", "Dobosz", "Stachurski", "Walaszczyk", "Spyrka", "Gach",
            "Jeżewski", "Bączek", "Drożdż", "Tworek", "Wantuch", "Marczewski", "Kurek", "Guzy", "Gorzkiewicz", "Łupiński", "Igielski",
            "Janiak", "Stojek", "Koźmiński", "Mieszczak", "Truszczyński", "Chabowski", "Zysk", "Konopa", "Dawidowicz", "Bogdan", "Malina",
            "Firlej", "Gołąbek", "Żaczek", "Maruszewski", "Czerw", "Matras", "Jurkiewicz", "Pater", "Próchniak", "Spychała", "Ścisłowski",
            "Suwała", "Paterek", "Kluczyński", "Jung", "Cebula", "Smolik", "Rzeszutek", "Stawiarz", "Pasierb", "Przywara", "Rygielski",
            "Dąbrowski", "Głodek", "Żółtowski", "Banasik", "Chrobot", "Domachowski", "Seremak", "Rykała", "Karasiewicz", "Sawczuk",
            "Rogiński", "Ferens", "Łukaszuk", "Majewski", "Kryński", "Kurzawski", "Małkiewicz", "Kułakowski", "Górna", "Czechowski",
            "Kądziołka", "Kobus", "Maćkowiak", "Ratajski", "Rygiel", "Podleśny", "Waszkiewicz", "Wilkowski", "Czubiński", "Deptuła",
            "Gawrysiak", "Sobkowicz", "Żak", "Połomski", "Bobowski", "Dawidziuk", "Ciupiński" };
